                ...
                <el-row :gutter="20" style="padding-top: 0px">
                    ...
                    <el-col :span="17" class="col1">
                        ...
                        <div class="nav_box">
                            ...
                            <div class="nav_3" style="color: #33CC99"><p>系统功能</p></div>
                            <div class="nav_4" v-if="userType === 1 || userType === 4"><router-link to="/applicationinquiry"><p style="color: white">个人申请</p></router-link></div>
                        </div>
                    </el-col>
                    <el-col :span="4">
                        <!--                        <div class="grid-content ep-bg-purple" />-->
...
export default {
    ...
    components: {ElMain, ElIcon,ElSubMenu,applyUser,auditUser,auditUserShow,filterClassroom_from,privateApplication,verifyUser,kjsInput,kjsOutput},
    data(){
        return {
            store,
